...
public class ModificacionArea extends JFrame {
	...
	private void inicializarComponentes() {
		...
		titulo.setBounds(100, 34, 261, 25);

		nombre = new JLabel();
		nombre.setFont(new Font("Tahoma", Font.BOLD, 11));
		nombre.setText("Nombre:");
		nombre.setBounds(50, 86, 100, 25);

		nombreTextField = new JTextField();
		nombreTextField.setBounds(160, 86, 200, 25);

		duracion = new JLabel();
		duracion.setFont(new Font("Tahoma", Font.BOLD, 11));
		duracion.setText("Descripción:");
		duracion.setBounds(50, 121, 100, 25);

		duracionTextField = new JTextField();
		duracionTextField.setBounds(160, 121, 200, 25);

		modificarButton = new JButton();
		modificarButton.setText("Modificar");
		modificarButton.setBounds(270, 164, 90, 25);

		atras = new JButton("Atrás");
		atras.setBounds(160, 164, 90, 25);
